...
export {
  ...
  GooglePhotosPickerCreateDocument as GOOGLE_PHOTOS_PICKER_CREATE,
  GooglePhotosPickerGetDocument as GOOGLE_PHOTOS_PICKER_GET,
  GooglePhotosPickerListDocument as GOOGLE_PHOTOS_PICKER_LIST,
  ...
  TodoCommentsDocument as TODO_COMMENTS,
  CreateTodoCommentDocument as CREATE_TODO_COMMENT,
  DeleteTodoCommentDocument as DELETE_TODO_COMMENT,
  ...
  LibraryBooksDocument as LIBRARY_BOOKS,
  LibraryNotesDocument as LIBRARY_NOTES,
  LibraryDevicesDocument as LIBRARY_DEVICES,
  LibraryNotificationsDocument as LIBRARY_NOTIFICATIONS,
  LibraryBookUpsertDocument as LIBRARY_BOOK_UPSERT,
  LibraryBookDeleteDocument as LIBRARY_BOOK_DELETE,
  LibraryNoteUpsertDocument as LIBRARY_NOTE_UPSERT,
  LibraryNoteDeleteDocument as LIBRARY_NOTE_DELETE,
  LibraryTriggerSyncDocument as LIBRARY_TRIGGER_SYNC,
  LibraryNotificationDeleteDocument as LIBRARY_NOTIFICATION_DELETE,

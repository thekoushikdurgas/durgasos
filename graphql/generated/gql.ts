...
type Documents = {
  ...
  'query LinkedGithubAccounts {\n  linkedGithubAccounts\n}\n\nquery GithubUser($username: String!, $githubUserId: String) {\n  githubUser(username: $username, githubUserId: $githubUserId)\n}\n\nquery GithubRepos($username: String!, $sort: String, $githubUserId: String) {\n  githubRepos(username: $username, sort: $sort, githubUserId: $githubUserId)\n}\n\nquery GithubStarred($username: String!, $githubUserId: String) {\n  githubStarred(username: $username, githubUserId: $githubUserId)\n}\n\nquery GithubReadme($username: String!, $githubUserId: String) {\n  githubReadme(username: $username, githubUserId: $githubUserId)\n}\n\nmutation AddLinkedGithubAccount($params: JSON!) {\n  addLinkedGithubAccount(params: $params)\n}\n\nmutation RemoveLinkedGithubAccount($githubUserId: String!) {\n  removeLinkedGithubAccount(githubUserId: $githubUserId)\n}': typeof types.LinkedGithubAccountsDocument;
  ...
  'query GooglePhotosList($params: JSON) {\n  googlePhotosList(params: $params)\n}\n\nquery GooglePhotosPickerCreate($params: JSON) {\n  googlePhotosPickerCreate(params: $params)\n}\n\nquery GooglePhotosPickerGet($params: JSON) {\n  googlePhotosPickerGet(params: $params)\n}\n\nquery GooglePhotosPickerList($params: JSON) {\n  googlePhotosPickerList(params: $params)\n}': typeof types.GooglePhotosListDocument;
...
const documents: Documents = {
  ...
  'query LinkedGithubAccounts {\n  linkedGithubAccounts\n}\n\nquery GithubUser($username: String!, $githubUserId: String) {\n  githubUser(username: $username, githubUserId: $githubUserId)\n}\n\nquery GithubRepos($username: String!, $sort: String, $githubUserId: String) {\n  githubRepos(username: $username, sort: $sort, githubUserId: $githubUserId)\n}\n\nquery GithubStarred($username: String!, $githubUserId: String) {\n  githubStarred(username: $username, githubUserId: $githubUserId)\n}\n\nquery GithubReadme($username: String!, $githubUserId: String) {\n  githubReadme(username: $username, githubUserId: $githubUserId)\n}\n\nmutation AddLinkedGithubAccount($params: JSON!) {\n  addLinkedGithubAccount(params: $params)\n}\n\nmutation RemoveLinkedGithubAccount($githubUserId: String!) {\n  removeLinkedGithubAccount(githubUserId: $githubUserId)\n}':
    types.LinkedGithubAccountsDocument,
  'query GmailListMessages($params: JSON) {\n  gmailListMessages(params: $params)\n}\n\nquery GmailGetMessage($params: JSON) {\n  gmailGetMessage(params: $params)\n}\n\nquery GmailListThreads($params: JSON) {\n  gmailListThreads(params: $params)\n}\n\nquery GmailGetThread($params: JSON) {\n  gmailGetThread(params: $params)\n}':
 ...
 */
export function gql(
  source: 'query LinkedGithubAccounts {\n  linkedGithubAccounts\n}\n\nquery GithubUser($username: String!, $githubUserId: String) {\n  githubUser(username: $username, githubUserId: $githubUserId)\n}\n\nquery GithubRepos($username: String!, $sort: String, $githubUserId: String) {\n  githubRepos(username: $username, sort: $sort, githubUserId: $githubUserId)\n}\n\nquery GithubStarred($username: String!, $githubUserId: String) {\n  githubStarred(username: $username, githubUserId: $githubUserId)\n}\n\nquery GithubReadme($username: String!, $githubUserId: String) {\n  githubReadme(username: $username, githubUserId: $githubUserId)\n}\n\nmutation AddLinkedGithubAccount($params: JSON!) {\n  addLinkedGithubAccount(params: $params)\n}\n\nmutation RemoveLinkedGithubAccount($githubUserId: String!) {\n  removeLinkedGithubAccount(githubUserId: $githubUserId)\n}'
): (typeof documents)['query LinkedGithubAccounts {\n  linkedGithubAccounts\n}\n\nquery GithubUser($username: String!, $githubUserId: String) {\n  githubUser(username: $username, githubUserId: $githubUserId)\n}\n\nquery GithubRepos($username: String!, $sort: String, $githubUserId: String) {\n  githubRepos(username: $username, sort: $sort, githubUserId: $githubUserId)\n}\n\nquery GithubStarred($username: String!, $githubUserId: String) {\n  githubStarred(username: $username, githubUserId: $githubUserId)\n}\n\nquery GithubReadme($username: String!, $githubUserId: String) {\n  githubReadme(username: $username, githubUserId: $githubUserId)\n}\n\nmutation AddLinkedGithubAccount($params: JSON!) {\n  addLinkedGithubAccount(params: $params)\n}\n\nmutation RemoveLinkedGithubAccount($githubUserId: String!) {\n  removeLinkedGithubAccount(githubUserId: $githubUserId)\n}'];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
 ...
 */
export function gql(
  source: 'query JobStatus($jobId: String!) {\n  jobStatus(jobId: $jobId) {\n    jobId\n    status\n    result\n    error\n    updatedAt\n  }\n}'
): (typeof documents)['query JobStatus($jobId: String!) {\n  jobStatus(jobId: $jobId) {\n    jobId\n    status\n    result\n    error\n    updatedAt\n  }\n}'];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
 ...
 */
export function gql(
  source: 'query WidgetLayout {\n  widgetLayout {\n    id\n    ownerId\n    layoutJson\n    updatedAt\n  }\n}\n\nmutation SaveWidgetLayout($layoutJson: JSON!) {\n  saveWidgetLayout(layoutJson: $layoutJson) {\n    id\n    ownerId\n    layoutJson\n    updatedAt\n  }\n}'
): (typeof documents)['query WidgetLayout {\n  widgetLayout {\n    id\n    ownerId\n    layoutJson\n    updatedAt\n  }\n}\n\nmutation SaveWidgetLayout($layoutJson: JSON!) {\n  saveWidgetLayout(layoutJson: $layoutJson) {\n    id\n    ownerId\n    layoutJson\n    updatedAt\n  }\n}'];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
